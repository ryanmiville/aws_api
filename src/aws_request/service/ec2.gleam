...
pub fn describe_instance_topology(
  client: Client,
  body: BitArray,
  headers: List(Header),
  query: Option(String),
...
pub fn describe_ipam_external_resource_verification_tokens(
  client: Client,
  body: BitArray,
  headers: List(Header),
  query: Option(String),
...
pub fn describe_locked_snapshots(
  client: Client,
  body: BitArray,
  headers: List(Header),
  query: Option(String),
...
pub fn enable_snapshot_block_public_access(
  client: Client,
  body: BitArray,
  headers: List(Header),
  query: Option(String),
...
pub fn get_instance_tpm_ek_pub(
  client: Client,
  body: BitArray,
  headers: List(Header),
  query: Option(String),
...
pub fn get_security_groups_for_vpc(
  client: Client,
  body: BitArray,
  headers: List(Header),
  query: Option(String),
