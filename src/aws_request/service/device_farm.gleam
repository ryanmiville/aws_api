...
pub fn create_device_pool(
  ...
  let target = client.builder.service_id <> ".CreateDevicePool"
...
pub fn create_network_profile(
  ...
  let target = client.builder.service_id <> ".CreateNetworkProfile"
  let headers = [#("X-Amz-Target", target), #("content-type", content_type)]
  request_builder.build(
    client.builder,
    http.Post,
...
pub fn create_remote_access_session(
  ...
  let target = client.builder.service_id <> ".CreateRemoteAccessSession"
  let headers = [#("X-Amz-Target", target), #("content-type", content_type)]
  request_builder.build(
    client.builder,
    http.Post,
...
pub fn create_test_grid_project(
  ...
  let target = client.builder.service_id <> ".CreateTestGridProject"
  let headers = [#("X-Amz-Target", target), #("content-type", content_type)]
  request_builder.build(
    client.builder,
    http.Post,
...
pub fn create_test_grid_url(
  ...
  let target = client.builder.service_id <> ".CreateTestGridUrl"
  let headers = [#("X-Amz-Target", target), #("content-type", content_type)]
  request_builder.build(
    client.builder,
    http.Post,
...
pub fn create_upload(
  ...
  let target = client.builder.service_id <> ".CreateUpload"
  let headers = [#("X-Amz-Target", target), #("content-type", content_type)]
  request_builder.build(
    client.builder,
    http.Post,
...
pub fn create_vpce_configuration(
  ...
  let target = client.builder.service_id <> ".CreateVPCEConfiguration"
  let headers = [#("X-Amz-Target", target), #("content-type", content_type)]
  request_builder.build(
    client.builder,
    http.Post,
...
pub fn delete_device_pool(
  ...
  let target = client.builder.service_id <> ".DeleteDevicePool"
  let headers = [#("X-Amz-Target", target), #("content-type", content_type)]
  request_builder.build(
    client.builder,
    http.Post,
...
pub fn delete_network_profile(
  ...
  let target = client.builder.service_id <> ".DeleteNetworkProfile"
  let headers = [#("X-Amz-Target", target), #("content-type", content_type)]
  request_builder.build(
    client.builder,
    http.Post,
...
pub fn delete_remote_access_session(
  ...
  let target = client.builder.service_id <> ".DeleteRemoteAccessSession"
  let headers = [#("X-Amz-Target", target), #("content-type", content_type)]
  request_builder.build(
    client.builder,
    http.Post,
...
pub fn delete_run(client: Client, request_body: BitArray) -> Request(BitArray) {
  let target = client.builder.service_id <> ".DeleteRun"
  let headers = [#("X-Amz-Target", target), #("content-type", content_type)]
  request_builder.build(
    client.builder,
    http.Post,
...
pub fn delete_test_grid_project(
  ...
  let target = client.builder.service_id <> ".DeleteTestGridProject"
  let headers = [#("X-Amz-Target", target), #("content-type", content_type)]
  request_builder.build(
    client.builder,
    http.Post,
...
pub fn delete_upload(
  ...
  let target = client.builder.service_id <> ".DeleteUpload"
  let headers = [#("X-Amz-Target", target), #("content-type", content_type)]
  request_builder.build(
    client.builder,
    http.Post,
...
pub fn delete_vpce_configuration(
  ...
  let target = client.builder.service_id <> ".DeleteVPCEConfiguration"
  let headers = [#("X-Amz-Target", target), #("content-type", content_type)]
  request_builder.build(
    client.builder,
    http.Post,
...
pub fn get_account_settings(
  ...
  let target = client.builder.service_id <> ".GetAccountSettings"
  let headers = [#("X-Amz-Target", target), #("content-type", content_type)]
  request_builder.build(
    client.builder,
    http.Post,
...
pub fn get_device_instance(
  ...
  let target = client.builder.service_id <> ".GetDeviceInstance"
  let headers = [#("X-Amz-Target", target), #("content-type", content_type)]
  request_builder.build(
    client.builder,
    http.Post,
...
pub fn get_device_pool(
  ...
  let target = client.builder.service_id <> ".GetDevicePool"
  let headers = [#("X-Amz-Target", target), #("content-type", content_type)]
  request_builder.build(
    client.builder,
    http.Post,
...
pub fn get_device_pool_compatibility(
  ...
  let target = client.builder.service_id <> ".GetDevicePoolCompatibility"
  let headers = [#("X-Amz-Target", target), #("content-type", content_type)]
  request_builder.build(
    client.builder,
    http.Post,
...
pub fn get_instance_profile(
  ...
  let target = client.builder.service_id <> ".GetInstanceProfile"
  let headers = [#("X-Amz-Target", target), #("content-type", content_type)]
  request_builder.build(
    client.builder,
    http.Post,
...
pub fn get_network_profile(
  ...
  let target = client.builder.service_id <> ".GetNetworkProfile"
  let headers = [#("X-Amz-Target", target), #("content-type", content_type)]
  request_builder.build(
    client.builder,
    http.Post,
...
pub fn get_offering_status(
  ...
  let target = client.builder.service_id <> ".GetOfferingStatus"
  let headers = [#("X-Amz-Target", target), #("content-type", content_type)]
  request_builder.build(
    client.builder,
    http.Post,
...
pub fn get_project(client: Client, request_body: BitArray) -> Request(BitArray) {
  let target = client.builder.service_id <> ".GetProject"
  let headers = [#("X-Amz-Target", target), #("content-type", content_type)]
  request_builder.build(
    client.builder,
    http.Post,
...
pub fn get_remote_access_session(
  ...
  let target = client.builder.service_id <> ".GetRemoteAccessSession"
  let headers = [#("X-Amz-Target", target), #("content-type", content_type)]
  request_builder.build(
    client.builder,
    http.Post,
...
pub fn get_run(client: Client, request_body: BitArray) -> Request(BitArray) {
  let target = client.builder.service_id <> ".GetRun"
  let headers = [#("X-Amz-Target", target), #("content-type", content_type)]
  request_builder.build(
    client.builder,
    http.Post,
...
pub fn get_suite(client: Client, request_body: BitArray) -> Request(BitArray) {
  let target = client.builder.service_id <> ".GetSuite"
  let headers = [#("X-Amz-Target", target), #("content-type", content_type)]
  request_builder.build(
    client.builder,
    http.Post,
...
pub fn get_test(client: Client, request_body: BitArray) -> Request(BitArray) {
  let target = client.builder.service_id <> ".GetTest"
  let headers = [#("X-Amz-Target", target), #("content-type", content_type)]
  request_builder.build(
    client.builder,
    http.Post,
...
pub fn get_test_grid_project(
  ...
  let target = client.builder.service_id <> ".GetTestGridProject"
  let headers = [#("X-Amz-Target", target), #("content-type", content_type)]
  request_builder.build(
    client.builder,
    http.Post,
...
pub fn get_test_grid_session(
  ...
  let target = client.builder.service_id <> ".GetTestGridSession"
  let headers = [#("X-Amz-Target", target), #("content-type", content_type)]
  request_builder.build(
    client.builder,
    http.Post,
...
pub fn get_upload(client: Client, request_body: BitArray) -> Request(BitArray) {
  let target = client.builder.service_id <> ".GetUpload"
  let headers = [#("X-Amz-Target", target), #("content-type", content_type)]
  request_builder.build(
    client.builder,
    http.Post,
...
pub fn get_vpce_configuration(
  ...
  let target = client.builder.service_id <> ".GetVPCEConfiguration"
  let headers = [#("X-Amz-Target", target), #("content-type", content_type)]
  request_builder.build(
    client.builder,
    http.Post,
...
pub fn install_to_remote_access_session(
  ...
  let target = client.builder.service_id <> ".InstallToRemoteAccessSession"
  let headers = [#("X-Amz-Target", target), #("content-type", content_type)]
  request_builder.build(
    client.builder,
    http.Post,
...
pub fn list_device_instances(
  ...
  let target = client.builder.service_id <> ".ListDeviceInstances"
  let headers = [#("X-Amz-Target", target), #("content-type", content_type)]
  request_builder.build(
    client.builder,
    http.Post,
...
pub fn list_device_pools(
  ...
  let target = client.builder.service_id <> ".ListDevicePools"
  let headers = [#("X-Amz-Target", target), #("content-type", content_type)]
  request_builder.build(
    client.builder,
    http.Post,
...
pub fn list_instance_profiles(
  ...
  let target = client.builder.service_id <> ".ListInstanceProfiles"
  let headers = [#("X-Amz-Target", target), #("content-type", content_type)]
  request_builder.build(
    client.builder,
    http.Post,
...
pub fn list_network_profiles(
  ...
  let target = client.builder.service_id <> ".ListNetworkProfiles"
  let headers = [#("X-Amz-Target", target), #("content-type", content_type)]
  request_builder.build(
    client.builder,
    http.Post,
...
pub fn list_offering_promotions(
  ...
  let target = client.builder.service_id <> ".ListOfferingPromotions"
  let headers = [#("X-Amz-Target", target), #("content-type", content_type)]
  request_builder.build(
    client.builder,
    http.Post,
...
pub fn list_offerings(
  ...
  let target = client.builder.service_id <> ".ListOfferings"
  let headers = [#("X-Amz-Target", target), #("content-type", content_type)]
  request_builder.build(
    client.builder,
    http.Post,
...
pub fn list_offering_transactions(
  ...
  let target = client.builder.service_id <> ".ListOfferingTransactions"
  let headers = [#("X-Amz-Target", target), #("content-type", content_type)]
  request_builder.build(
    client.builder,
    http.Post,
...
pub fn list_remote_access_sessions(
  ...
  let target = client.builder.service_id <> ".ListRemoteAccessSessions"
  let headers = [#("X-Amz-Target", target), #("content-type", content_type)]
  request_builder.build(
    client.builder,
    http.Post,
...
pub fn list_runs(client: Client, request_body: BitArray) -> Request(BitArray) {
  let target = client.builder.service_id <> ".ListRuns"
  let headers = [#("X-Amz-Target", target), #("content-type", content_type)]
  request_builder.build(
    client.builder,
    http.Post,
...
pub fn list_samples(client: Client, request_body: BitArray) -> Request(BitArray) {
  let target = client.builder.service_id <> ".ListSamples"
  let headers = [#("X-Amz-Target", target), #("content-type", content_type)]
  request_builder.build(
    client.builder,
    http.Post,
...
pub fn list_suites(client: Client, request_body: BitArray) -> Request(BitArray) {
  let target = client.builder.service_id <> ".ListSuites"
  let headers = [#("X-Amz-Target", target), #("content-type", content_type)]
  request_builder.build(
    client.builder,
    http.Post,
...
pub fn list_test_grid_projects(
  ...
  let target = client.builder.service_id <> ".ListTestGridProjects"
  let headers = [#("X-Amz-Target", target), #("content-type", content_type)]
  request_builder.build(
    client.builder,
    http.Post,
...
pub fn list_test_grid_session_actions(
  ...
  let target = client.builder.service_id <> ".ListTestGridSessionActions"
  let headers = [#("X-Amz-Target", target), #("content-type", content_type)]
  request_builder.build(
    client.builder,
    http.Post,
...
pub fn list_test_grid_session_artifacts(
  ...
  let target = client.builder.service_id <> ".ListTestGridSessionArtifacts"
  let headers = [#("X-Amz-Target", target), #("content-type", content_type)]
  request_builder.build(
    client.builder,
    http.Post,
...
pub fn list_test_grid_sessions(
  ...
  let target = client.builder.service_id <> ".ListTestGridSessions"
  let headers = [#("X-Amz-Target", target), #("content-type", content_type)]
  request_builder.build(
    client.builder,
    http.Post,
...
pub fn list_tests(client: Client, request_body: BitArray) -> Request(BitArray) {
  let target = client.builder.service_id <> ".ListTests"
  let headers = [#("X-Amz-Target", target), #("content-type", content_type)]
  request_builder.build(
    client.builder,
    http.Post,
...
pub fn list_unique_problems(
  ...
  let target = client.builder.service_id <> ".ListUniqueProblems"
  let headers = [#("X-Amz-Target", target), #("content-type", content_type)]
  request_builder.build(
    client.builder,
    http.Post,
...
pub fn list_uploads(client: Client, request_body: BitArray) -> Request(BitArray) {
  let target = client.builder.service_id <> ".ListUploads"
  let headers = [#("X-Amz-Target", target), #("content-type", content_type)]
  request_builder.build(
    client.builder,
    http.Post,
...
pub fn list_vpce_configurations(
  ...
  let target = client.builder.service_id <> ".ListVPCEConfigurations"
  let headers = [#("X-Amz-Target", target), #("content-type", content_type)]
  request_builder.build(
    client.builder,
    http.Post,
...
pub fn purchase_offering(
  ...
  let target = client.builder.service_id <> ".PurchaseOffering"
  let headers = [#("X-Amz-Target", target), #("content-type", content_type)]
  request_builder.build(
    client.builder,
    http.Post,
...
pub fn renew_offering(
  ...
  let target = client.builder.service_id <> ".RenewOffering"
  let headers = [#("X-Amz-Target", target), #("content-type", content_type)]
  request_builder.build(
    client.builder,
    http.Post,
...
pub fn schedule_run(client: Client, request_body: BitArray) -> Request(BitArray) {
  let target = client.builder.service_id <> ".ScheduleRun"
  let headers = [#("X-Amz-Target", target), #("content-type", content_type)]
  request_builder.build(
    client.builder,
    http.Post,
...
pub fn stop_job(client: Client, request_body: BitArray) -> Request(BitArray) {
  let target = client.builder.service_id <> ".StopJob"
  let headers = [#("X-Amz-Target", target), #("content-type", content_type)]
  request_builder.build(
    client.builder,
    http.Post,
...
pub fn stop_remote_access_session(
  ...
  let target = client.builder.service_id <> ".StopRemoteAccessSession"
  let headers = [#("X-Amz-Target", target), #("content-type", content_type)]
  request_builder.build(
    client.builder,
    http.Post,
...
pub fn stop_run(client: Client, request_body: BitArray) -> Request(BitArray) {
  let target = client.builder.service_id <> ".StopRun"
  let headers = [#("X-Amz-Target", target), #("content-type", content_type)]
  request_builder.build(
    client.builder,
    http.Post,
...
pub fn update_device_instance(
  ...
  let target = client.builder.service_id <> ".UpdateDeviceInstance"
  let headers = [#("X-Amz-Target", target), #("content-type", content_type)]
  request_builder.build(
    client.builder,
    http.Post,
...
pub fn update_device_pool(
  ...
  let target = client.builder.service_id <> ".UpdateDevicePool"
  let headers = [#("X-Amz-Target", target), #("content-type", content_type)]
  request_builder.build(
    client.builder,
    http.Post,
...
pub fn update_instance_profile(
  ...
  let target = client.builder.service_id <> ".UpdateInstanceProfile"
  let headers = [#("X-Amz-Target", target), #("content-type", content_type)]
  request_builder.build(
    client.builder,
    http.Post,
...
pub fn update_network_profile(
  ...
  let target = client.builder.service_id <> ".UpdateNetworkProfile"
  let headers = [#("X-Amz-Target", target), #("content-type", content_type)]
  request_builder.build(
    client.builder,
    http.Post,
...
pub fn update_test_grid_project(
  ...
  let target = client.builder.service_id <> ".UpdateTestGridProject"
  let headers = [#("X-Amz-Target", target), #("content-type", content_type)]
  request_builder.build(
    client.builder,
    http.Post,
...
pub fn update_upload(
  ...
  let target = client.builder.service_id <> ".UpdateUpload"
  let headers = [#("X-Amz-Target", target), #("content-type", content_type)]
  request_builder.build(
    client.builder,
    http.Post,
...
pub fn update_vpce_configuration(
  ...
  let target = client.builder.service_id <> ".UpdateVPCEConfiguration"
  let headers = [#("X-Amz-Target", target), #("content-type", content_type)]
  request_builder.build(
    client.builder,
    http.Post,
