...
pub fn create_custom_domain_association(
  ...
  let target = client.builder.service_id <> ".CreateCustomDomainAssociation"
...
pub fn delete_custom_domain_association(
  ...
  let target = client.builder.service_id <> ".DeleteCustomDomainAssociation"
  let headers = [#("X-Amz-Target", target), #("content-type", content_type)]
  request_builder.build(
    client.builder,
    http.Post,
...
pub fn get_credentials(
  ...
  let target = client.builder.service_id <> ".GetCredentials"
  let headers = [#("X-Amz-Target", target), #("content-type", content_type)]
  request_builder.build(
    client.builder,
    http.Post,
...
pub fn get_custom_domain_association(
  ...
  let target = client.builder.service_id <> ".GetCustomDomainAssociation"
  let headers = [#("X-Amz-Target", target), #("content-type", content_type)]
  request_builder.build(
    client.builder,
    http.Post,
...
pub fn list_custom_domain_associations(
  ...
  let target = client.builder.service_id <> ".ListCustomDomainAssociations"
  let headers = [#("X-Amz-Target", target), #("content-type", content_type)]
  request_builder.build(
    client.builder,
    http.Post,
...
pub fn update_custom_domain_association(
  ...
  let target = client.builder.service_id <> ".UpdateCustomDomainAssociation"
  let headers = [#("X-Amz-Target", target), #("content-type", content_type)]
  request_builder.build(
    client.builder,
    http.Post,
