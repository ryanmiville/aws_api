...
pub fn check_capacity(
  ...
  let target = client.builder.service_id <> ".CheckCapacity"
  let headers = [#("X-Amz-Target", target), #("content-type", content_type)]
  request_builder.build(
    client.builder,
    http.Post,
...
pub fn create_api_key(
  ...
  let target = client.builder.service_id <> ".CreateAPIKey"
  let headers = [#("X-Amz-Target", target), #("content-type", content_type)]
  request_builder.build(
    client.builder,
    http.Post,
...
pub fn delete_api_key(
  ...
  let target = client.builder.service_id <> ".DeleteAPIKey"
  let headers = [#("X-Amz-Target", target), #("content-type", content_type)]
  request_builder.build(
    client.builder,
    http.Post,
...
pub fn delete_firewall_manager_rule_groups(
  ...
  let target = client.builder.service_id <> ".DeleteFirewallManagerRuleGroups"
  let headers = [#("X-Amz-Target", target), #("content-type", content_type)]
  request_builder.build(
    client.builder,
    http.Post,
...
pub fn describe_all_managed_products(
  ...
  let target = client.builder.service_id <> ".DescribeAllManagedProducts"
  let headers = [#("X-Amz-Target", target), #("content-type", content_type)]
  request_builder.build(
    client.builder,
    http.Post,
...
pub fn describe_managed_products_by_vendor(
  ...
  let target = client.builder.service_id <> ".DescribeManagedProductsByVendor"
  let headers = [#("X-Amz-Target", target), #("content-type", content_type)]
  request_builder.build(
    client.builder,
    http.Post,
...
pub fn describe_managed_rule_group(
  ...
  let target = client.builder.service_id <> ".DescribeManagedRuleGroup"
  let headers = [#("X-Amz-Target", target), #("content-type", content_type)]
  request_builder.build(
    client.builder,
    http.Post,
...
pub fn generate_mobile_sdk_release_url(
  ...
  let target = client.builder.service_id <> ".GenerateMobileSdkReleaseUrl"
  let headers = [#("X-Amz-Target", target), #("content-type", content_type)]
  request_builder.build(
    client.builder,
    http.Post,
...
pub fn get_decrypted_api_key(
  ...
  let target = client.builder.service_id <> ".GetDecryptedAPIKey"
  let headers = [#("X-Amz-Target", target), #("content-type", content_type)]
  request_builder.build(
    client.builder,
    http.Post,
...
pub fn get_managed_rule_set(
  ...
  let target = client.builder.service_id <> ".GetManagedRuleSet"
  let headers = [#("X-Amz-Target", target), #("content-type", content_type)]
  request_builder.build(
    client.builder,
    http.Post,
...
pub fn get_mobile_sdk_release(
  ...
  let target = client.builder.service_id <> ".GetMobileSdkRelease"
  let headers = [#("X-Amz-Target", target), #("content-type", content_type)]
  request_builder.build(
    client.builder,
    http.Post,
...
pub fn get_rate_based_statement_managed_keys(
  ...
  let target = client.builder.service_id <> ".GetRateBasedStatementManagedKeys"
  let headers = [#("X-Amz-Target", target), #("content-type", content_type)]
  request_builder.build(
    client.builder,
    http.Post,
...
pub fn list_api_keys(
  ...
  let target = client.builder.service_id <> ".ListAPIKeys"
  let headers = [#("X-Amz-Target", target), #("content-type", content_type)]
  request_builder.build(
    client.builder,
    http.Post,
...
pub fn list_available_managed_rule_groups(
  ...
  let target = client.builder.service_id <> ".ListAvailableManagedRuleGroups"
  let headers = [#("X-Amz-Target", target), #("content-type", content_type)]
  request_builder.build(
    client.builder,
    http.Post,
...
pub fn list_available_managed_rule_group_versions(
  ...
  let target =
    client.builder.service_id <> ".ListAvailableManagedRuleGroupVersions"
  let headers = [#("X-Amz-Target", target), #("content-type", content_type)]
  request_builder.build(
    client.builder,
    http.Post,
...
pub fn list_managed_rule_sets(
  ...
  let target = client.builder.service_id <> ".ListManagedRuleSets"
  let headers = [#("X-Amz-Target", target), #("content-type", content_type)]
  request_builder.build(
    client.builder,
    http.Post,
...
pub fn list_mobile_sdk_releases(
  ...
  let target = client.builder.service_id <> ".ListMobileSdkReleases"
  let headers = [#("X-Amz-Target", target), #("content-type", content_type)]
  request_builder.build(
    client.builder,
    http.Post,
...
pub fn put_managed_rule_set_versions(
  ...
  let target = client.builder.service_id <> ".PutManagedRuleSetVersions"
  let headers = [#("X-Amz-Target", target), #("content-type", content_type)]
  request_builder.build(
    client.builder,
    http.Post,
...
pub fn update_managed_rule_set_version_expiry_date(
  ...
  let target =
    client.builder.service_id <> ".UpdateManagedRuleSetVersionExpiryDate"
  let headers = [#("X-Amz-Target", target), #("content-type", content_type)]
  request_builder.build(
    client.builder,
    http.Post,
