...
pub fn associate_delegate_to_resource(
  ...
  let target = client.builder.service_id <> ".AssociateDelegateToResource"
...
pub fn associate_member_to_group(
  ...
  let target = client.builder.service_id <> ".AssociateMemberToGroup"
  let headers = [#("X-Amz-Target", target), #("content-type", content_type)]
  request_builder.build(
    client.builder,
    http.Post,
...
pub fn assume_impersonation_role(
  ...
  let target = client.builder.service_id <> ".AssumeImpersonationRole"
  let headers = [#("X-Amz-Target", target), #("content-type", content_type)]
  request_builder.build(
    client.builder,
    http.Post,
...
pub fn cancel_mailbox_export_job(
  ...
  let target = client.builder.service_id <> ".CancelMailboxExportJob"
  let headers = [#("X-Amz-Target", target), #("content-type", content_type)]
  request_builder.build(
    client.builder,
    http.Post,
...
pub fn create_availability_configuration(
  ...
  let target = client.builder.service_id <> ".CreateAvailabilityConfiguration"
  let headers = [#("X-Amz-Target", target), #("content-type", content_type)]
  request_builder.build(
    client.builder,
    http.Post,
...
pub fn create_impersonation_role(
  ...
  let target = client.builder.service_id <> ".CreateImpersonationRole"
  let headers = [#("X-Amz-Target", target), #("content-type", content_type)]
  request_builder.build(
    client.builder,
    http.Post,
...
pub fn create_mobile_device_access_rule(
  ...
  let target = client.builder.service_id <> ".CreateMobileDeviceAccessRule"
  let headers = [#("X-Amz-Target", target), #("content-type", content_type)]
  request_builder.build(
    client.builder,
    http.Post,
...
pub fn delete_access_control_rule(
  ...
  let target = client.builder.service_id <> ".DeleteAccessControlRule"
  let headers = [#("X-Amz-Target", target), #("content-type", content_type)]
  request_builder.build(
    client.builder,
    http.Post,
...
pub fn delete_availability_configuration(
  ...
  let target = client.builder.service_id <> ".DeleteAvailabilityConfiguration"
  let headers = [#("X-Amz-Target", target), #("content-type", content_type)]
  request_builder.build(
    client.builder,
    http.Post,
...
pub fn delete_email_monitoring_configuration(
  ...
  let target =
    client.builder.service_id <> ".DeleteEmailMonitoringConfiguration"
  let headers = [#("X-Amz-Target", target), #("content-type", content_type)]
  request_builder.build(
    client.builder,
    http.Post,
...
pub fn delete_impersonation_role(
  ...
  let target = client.builder.service_id <> ".DeleteImpersonationRole"
  let headers = [#("X-Amz-Target", target), #("content-type", content_type)]
  request_builder.build(
    client.builder,
    http.Post,
...
pub fn delete_mailbox_permissions(
  ...
  let target = client.builder.service_id <> ".DeleteMailboxPermissions"
  let headers = [#("X-Amz-Target", target), #("content-type", content_type)]
  request_builder.build(
    client.builder,
    http.Post,
...
pub fn delete_mobile_device_access_override(
  ...
  let target = client.builder.service_id <> ".DeleteMobileDeviceAccessOverride"
  let headers = [#("X-Amz-Target", target), #("content-type", content_type)]
  request_builder.build(
    client.builder,
    http.Post,
...
pub fn delete_mobile_device_access_rule(
  ...
  let target = client.builder.service_id <> ".DeleteMobileDeviceAccessRule"
  let headers = [#("X-Amz-Target", target), #("content-type", content_type)]
  request_builder.build(
    client.builder,
    http.Post,
...
pub fn delete_retention_policy(
  ...
  let target = client.builder.service_id <> ".DeleteRetentionPolicy"
  let headers = [#("X-Amz-Target", target), #("content-type", content_type)]
  request_builder.build(
    client.builder,
    http.Post,
...
pub fn deregister_from_work_mail(
  ...
  let target = client.builder.service_id <> ".DeregisterFromWorkMail"
  let headers = [#("X-Amz-Target", target), #("content-type", content_type)]
  request_builder.build(
    client.builder,
    http.Post,
...
pub fn deregister_mail_domain(
  ...
  let target = client.builder.service_id <> ".DeregisterMailDomain"
  let headers = [#("X-Amz-Target", target), #("content-type", content_type)]
  request_builder.build(
    client.builder,
    http.Post,
...
pub fn describe_email_monitoring_configuration(
  ...
  let target =
    client.builder.service_id <> ".DescribeEmailMonitoringConfiguration"
  let headers = [#("X-Amz-Target", target), #("content-type", content_type)]
  request_builder.build(
    client.builder,
    http.Post,
...
pub fn describe_entity(
  ...
  let target = client.builder.service_id <> ".DescribeEntity"
  let headers = [#("X-Amz-Target", target), #("content-type", content_type)]
  request_builder.build(
    client.builder,
    http.Post,
...
pub fn describe_group(
  ...
  let target = client.builder.service_id <> ".DescribeGroup"
  let headers = [#("X-Amz-Target", target), #("content-type", content_type)]
  request_builder.build(
    client.builder,
    http.Post,
...
pub fn describe_inbound_dmarc_settings(
  ...
  let target = client.builder.service_id <> ".DescribeInboundDmarcSettings"
  let headers = [#("X-Amz-Target", target), #("content-type", content_type)]
  request_builder.build(
    client.builder,
    http.Post,
...
pub fn describe_mailbox_export_job(
  ...
  let target = client.builder.service_id <> ".DescribeMailboxExportJob"
  let headers = [#("X-Amz-Target", target), #("content-type", content_type)]
  request_builder.build(
    client.builder,
    http.Post,
...
pub fn describe_resource(
  ...
  let target = client.builder.service_id <> ".DescribeResource"
  let headers = [#("X-Amz-Target", target), #("content-type", content_type)]
  request_builder.build(
    client.builder,
    http.Post,
...
pub fn describe_user(
  ...
  let target = client.builder.service_id <> ".DescribeUser"
  let headers = [#("X-Amz-Target", target), #("content-type", content_type)]
  request_builder.build(
    client.builder,
    http.Post,
...
pub fn disassociate_delegate_from_resource(
  ...
  let target = client.builder.service_id <> ".DisassociateDelegateFromResource"
  let headers = [#("X-Amz-Target", target), #("content-type", content_type)]
  request_builder.build(
    client.builder,
    http.Post,
...
pub fn disassociate_member_from_group(
  ...
  let target = client.builder.service_id <> ".DisassociateMemberFromGroup"
  let headers = [#("X-Amz-Target", target), #("content-type", content_type)]
  request_builder.build(
    client.builder,
    http.Post,
...
pub fn get_access_control_effect(
  ...
  let target = client.builder.service_id <> ".GetAccessControlEffect"
  let headers = [#("X-Amz-Target", target), #("content-type", content_type)]
  request_builder.build(
    client.builder,
    http.Post,
...
pub fn get_default_retention_policy(
  ...
  let target = client.builder.service_id <> ".GetDefaultRetentionPolicy"
  let headers = [#("X-Amz-Target", target), #("content-type", content_type)]
  request_builder.build(
    client.builder,
    http.Post,
...
pub fn get_impersonation_role(
  ...
  let target = client.builder.service_id <> ".GetImpersonationRole"
  let headers = [#("X-Amz-Target", target), #("content-type", content_type)]
  request_builder.build(
    client.builder,
    http.Post,
...
pub fn get_impersonation_role_effect(
  ...
  let target = client.builder.service_id <> ".GetImpersonationRoleEffect"
  let headers = [#("X-Amz-Target", target), #("content-type", content_type)]
  request_builder.build(
    client.builder,
    http.Post,
...
pub fn get_mailbox_details(
  ...
  let target = client.builder.service_id <> ".GetMailboxDetails"
  let headers = [#("X-Amz-Target", target), #("content-type", content_type)]
  request_builder.build(
    client.builder,
    http.Post,
...
pub fn get_mail_domain(
  ...
  let target = client.builder.service_id <> ".GetMailDomain"
  let headers = [#("X-Amz-Target", target), #("content-type", content_type)]
  request_builder.build(
    client.builder,
    http.Post,
...
pub fn get_mobile_device_access_effect(
  ...
  let target = client.builder.service_id <> ".GetMobileDeviceAccessEffect"
  let headers = [#("X-Amz-Target", target), #("content-type", content_type)]
  request_builder.build(
    client.builder,
    http.Post,
...
pub fn get_mobile_device_access_override(
  ...
  let target = client.builder.service_id <> ".GetMobileDeviceAccessOverride"
  let headers = [#("X-Amz-Target", target), #("content-type", content_type)]
  request_builder.build(
    client.builder,
    http.Post,
...
pub fn list_access_control_rules(
  ...
  let target = client.builder.service_id <> ".ListAccessControlRules"
  let headers = [#("X-Amz-Target", target), #("content-type", content_type)]
  request_builder.build(
    client.builder,
    http.Post,
...
pub fn list_availability_configurations(
  ...
  let target = client.builder.service_id <> ".ListAvailabilityConfigurations"
  let headers = [#("X-Amz-Target", target), #("content-type", content_type)]
  request_builder.build(
    client.builder,
    http.Post,
...
pub fn list_group_members(
  ...
  let target = client.builder.service_id <> ".ListGroupMembers"
  let headers = [#("X-Amz-Target", target), #("content-type", content_type)]
  request_builder.build(
    client.builder,
    http.Post,
...
pub fn list_groups_for_entity(
  ...
  let target = client.builder.service_id <> ".ListGroupsForEntity"
  let headers = [#("X-Amz-Target", target), #("content-type", content_type)]
  request_builder.build(
    client.builder,
    http.Post,
...
pub fn list_impersonation_roles(
  ...
  let target = client.builder.service_id <> ".ListImpersonationRoles"
  let headers = [#("X-Amz-Target", target), #("content-type", content_type)]
  request_builder.build(
    client.builder,
    http.Post,
...
pub fn list_mailbox_export_jobs(
  ...
  let target = client.builder.service_id <> ".ListMailboxExportJobs"
  let headers = [#("X-Amz-Target", target), #("content-type", content_type)]
  request_builder.build(
    client.builder,
    http.Post,
...
pub fn list_mailbox_permissions(
  ...
  let target = client.builder.service_id <> ".ListMailboxPermissions"
  let headers = [#("X-Amz-Target", target), #("content-type", content_type)]
  request_builder.build(
    client.builder,
    http.Post,
...
pub fn list_mail_domains(
  ...
  let target = client.builder.service_id <> ".ListMailDomains"
  let headers = [#("X-Amz-Target", target), #("content-type", content_type)]
  request_builder.build(
    client.builder,
    http.Post,
...
pub fn list_mobile_device_access_overrides(
  ...
  let target = client.builder.service_id <> ".ListMobileDeviceAccessOverrides"
  let headers = [#("X-Amz-Target", target), #("content-type", content_type)]
  request_builder.build(
    client.builder,
    http.Post,
...
pub fn list_mobile_device_access_rules(
  ...
  let target = client.builder.service_id <> ".ListMobileDeviceAccessRules"
  let headers = [#("X-Amz-Target", target), #("content-type", content_type)]
  request_builder.build(
    client.builder,
    http.Post,
...
pub fn list_organizations(
  ...
  let target = client.builder.service_id <> ".ListOrganizations"
  let headers = [#("X-Amz-Target", target), #("content-type", content_type)]
  request_builder.build(
    client.builder,
    http.Post,
...
pub fn list_resource_delegates(
  ...
  let target = client.builder.service_id <> ".ListResourceDelegates"
  let headers = [#("X-Amz-Target", target), #("content-type", content_type)]
  request_builder.build(
    client.builder,
    http.Post,
...
pub fn put_access_control_rule(
  ...
  let target = client.builder.service_id <> ".PutAccessControlRule"
  let headers = [#("X-Amz-Target", target), #("content-type", content_type)]
  request_builder.build(
    client.builder,
    http.Post,
...
pub fn put_email_monitoring_configuration(
  ...
  let target = client.builder.service_id <> ".PutEmailMonitoringConfiguration"
  let headers = [#("X-Amz-Target", target), #("content-type", content_type)]
  request_builder.build(
    client.builder,
    http.Post,
...
pub fn put_inbound_dmarc_settings(
  ...
  let target = client.builder.service_id <> ".PutInboundDmarcSettings"
  let headers = [#("X-Amz-Target", target), #("content-type", content_type)]
  request_builder.build(
    client.builder,
    http.Post,
...
pub fn put_mailbox_permissions(
  ...
  let target = client.builder.service_id <> ".PutMailboxPermissions"
  let headers = [#("X-Amz-Target", target), #("content-type", content_type)]
  request_builder.build(
    client.builder,
    http.Post,
...
pub fn put_mobile_device_access_override(
  ...
  let target = client.builder.service_id <> ".PutMobileDeviceAccessOverride"
  let headers = [#("X-Amz-Target", target), #("content-type", content_type)]
  request_builder.build(
    client.builder,
    http.Post,
...
pub fn put_retention_policy(
  ...
  let target = client.builder.service_id <> ".PutRetentionPolicy"
  let headers = [#("X-Amz-Target", target), #("content-type", content_type)]
  request_builder.build(
    client.builder,
    http.Post,
...
pub fn register_mail_domain(
  ...
  let target = client.builder.service_id <> ".RegisterMailDomain"
  let headers = [#("X-Amz-Target", target), #("content-type", content_type)]
  request_builder.build(
    client.builder,
    http.Post,
...
pub fn register_to_work_mail(
  ...
  let target = client.builder.service_id <> ".RegisterToWorkMail"
  let headers = [#("X-Amz-Target", target), #("content-type", content_type)]
  request_builder.build(
    client.builder,
    http.Post,
...
pub fn reset_password(
  ...
  let target = client.builder.service_id <> ".ResetPassword"
  let headers = [#("X-Amz-Target", target), #("content-type", content_type)]
  request_builder.build(
    client.builder,
    http.Post,
...
pub fn start_mailbox_export_job(
  ...
  let target = client.builder.service_id <> ".StartMailboxExportJob"
  let headers = [#("X-Amz-Target", target), #("content-type", content_type)]
  request_builder.build(
    client.builder,
    http.Post,
...
pub fn test_availability_configuration(
  ...
  let target = client.builder.service_id <> ".TestAvailabilityConfiguration"
  let headers = [#("X-Amz-Target", target), #("content-type", content_type)]
  request_builder.build(
    client.builder,
    http.Post,
...
pub fn update_availability_configuration(
  ...
  let target = client.builder.service_id <> ".UpdateAvailabilityConfiguration"
  let headers = [#("X-Amz-Target", target), #("content-type", content_type)]
  request_builder.build(
    client.builder,
    http.Post,
...
pub fn update_default_mail_domain(
  ...
  let target = client.builder.service_id <> ".UpdateDefaultMailDomain"
  let headers = [#("X-Amz-Target", target), #("content-type", content_type)]
  request_builder.build(
    client.builder,
    http.Post,
...
pub fn update_impersonation_role(
  ...
  let target = client.builder.service_id <> ".UpdateImpersonationRole"
  let headers = [#("X-Amz-Target", target), #("content-type", content_type)]
  request_builder.build(
    client.builder,
    http.Post,
...
pub fn update_mailbox_quota(
  ...
  let target = client.builder.service_id <> ".UpdateMailboxQuota"
  let headers = [#("X-Amz-Target", target), #("content-type", content_type)]
  request_builder.build(
    client.builder,
    http.Post,
...
pub fn update_mobile_device_access_rule(
  ...
  let target = client.builder.service_id <> ".UpdateMobileDeviceAccessRule"
  let headers = [#("X-Amz-Target", target), #("content-type", content_type)]
  request_builder.build(
    client.builder,
    http.Post,
...
pub fn update_primary_email_address(
  ...
  let target = client.builder.service_id <> ".UpdatePrimaryEmailAddress"
  let headers = [#("X-Amz-Target", target), #("content-type", content_type)]
  request_builder.build(
    client.builder,
    http.Post,
