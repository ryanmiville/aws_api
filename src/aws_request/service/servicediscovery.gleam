...
pub fn create_http_namespace(
  ...
  let target = metadata.service_id <> ".CreateHttpNamespace"
...
pub fn create_private_dns_namespace(
  ...
  let target = metadata.service_id <> ".CreatePrivateDnsNamespace"
  let headers = [#("X-Amz-Target", target), #("content-type", content_type)]
  request_builder.build(
    client.signer,
    client.endpoint,
...
pub fn create_public_dns_namespace(
  ...
  let target = metadata.service_id <> ".CreatePublicDnsNamespace"
  let headers = [#("X-Amz-Target", target), #("content-type", content_type)]
  request_builder.build(
    client.signer,
    client.endpoint,
...
pub fn discover_instances(
  ...
  let target = metadata.service_id <> ".DiscoverInstances"
  let headers = [#("X-Amz-Target", target), #("content-type", content_type)]
  request_builder.build(
    client.signer,
    client.endpoint,
...
pub fn discover_instances_revision(
  ...
  let target = metadata.service_id <> ".DiscoverInstancesRevision"
  let headers = [#("X-Amz-Target", target), #("content-type", content_type)]
  request_builder.build(
    client.signer,
    client.endpoint,
...
pub fn get_instances_health_status(
  ...
  let target = metadata.service_id <> ".GetInstancesHealthStatus"
  let headers = [#("X-Amz-Target", target), #("content-type", content_type)]
  request_builder.build(
    client.signer,
    client.endpoint,
...
pub fn get_namespace(
  ...
  let target = metadata.service_id <> ".GetNamespace"
  let headers = [#("X-Amz-Target", target), #("content-type", content_type)]
  request_builder.build(
    client.signer,
    client.endpoint,
...
pub fn get_service(client: Client, request_body: BitArray) -> Request(BitArray) {
  let target = metadata.service_id <> ".GetService"
  let headers = [#("X-Amz-Target", target), #("content-type", content_type)]
  request_builder.build(
    client.signer,
    client.endpoint,
...
pub fn list_namespaces(
  ...
  let target = metadata.service_id <> ".ListNamespaces"
  let headers = [#("X-Amz-Target", target), #("content-type", content_type)]
  request_builder.build(
    client.signer,
    client.endpoint,
...
pub fn update_http_namespace(
  ...
  let target = metadata.service_id <> ".UpdateHttpNamespace"
  let headers = [#("X-Amz-Target", target), #("content-type", content_type)]
  request_builder.build(
    client.signer,
    client.endpoint,
...
pub fn update_instance_custom_health_status(
  ...
  let target = metadata.service_id <> ".UpdateInstanceCustomHealthStatus"
  let headers = [#("X-Amz-Target", target), #("content-type", content_type)]
  request_builder.build(
    client.signer,
    client.endpoint,
...
pub fn update_private_dns_namespace(
  ...
  let target = metadata.service_id <> ".UpdatePrivateDnsNamespace"
  let headers = [#("X-Amz-Target", target), #("content-type", content_type)]
  request_builder.build(
    client.signer,
    client.endpoint,
...
pub fn update_public_dns_namespace(
  ...
  let target = metadata.service_id <> ".UpdatePublicDnsNamespace"
  let headers = [#("X-Amz-Target", target), #("content-type", content_type)]
  request_builder.build(
    client.signer,
    client.endpoint,
