...
const metadata = Metadata(
  ...
  service_id: "Timestream_20181101",
...
pub fn create_batch_load_task(
  ...
  let target = metadata.service_id <> ".CreateBatchLoadTask"
...
pub fn describe_batch_load_task(
  ...
  let target = metadata.service_id <> ".DescribeBatchLoadTask"
  let headers = [#("X-Amz-Target", target), #("content-type", content_type)]
  request_builder.build(
    client.signer,
    client.endpoint,
...
pub fn describe_database(
  ...
  let target = metadata.service_id <> ".DescribeDatabase"
  let headers = [#("X-Amz-Target", target), #("content-type", content_type)]
  request_builder.build(
    client.signer,
    client.endpoint,
...
pub fn list_batch_load_tasks(
  ...
  let target = metadata.service_id <> ".ListBatchLoadTasks"
  let headers = [#("X-Amz-Target", target), #("content-type", content_type)]
  request_builder.build(
    client.signer,
    client.endpoint,
...
pub fn resume_batch_load_task(
  ...
  let target = metadata.service_id <> ".ResumeBatchLoadTask"
  let headers = [#("X-Amz-Target", target), #("content-type", content_type)]
  request_builder.build(
    client.signer,
    client.endpoint,
...
pub fn write_records(
  ...
  let target = metadata.service_id <> ".WriteRecords"
  let headers = [#("X-Amz-Target", target), #("content-type", content_type)]
  request_builder.build(
    client.signer,
    client.endpoint,
