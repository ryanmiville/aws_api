...
pub fn delete_report_definition(
  ...
  let target = client.builder.service_id <> ".DeleteReportDefinition"
...
pub fn describe_report_definitions(
  ...
  let target = client.builder.service_id <> ".DescribeReportDefinitions"
  let headers = [#("X-Amz-Target", target), #("content-type", content_type)]
  request_builder.build(
    client.builder,
    http.Post,
...
pub fn modify_report_definition(
  ...
  let target = client.builder.service_id <> ".ModifyReportDefinition"
  let headers = [#("X-Amz-Target", target), #("content-type", content_type)]
  request_builder.build(
    client.builder,
    http.Post,
...
pub fn put_report_definition(
  ...
  let target = client.builder.service_id <> ".PutReportDefinition"
  let headers = [#("X-Amz-Target", target), #("content-type", content_type)]
  request_builder.build(
    client.builder,
    http.Post,
