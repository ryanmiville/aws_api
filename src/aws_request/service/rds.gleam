...
pub fn describe_db_recommendations(
  client: Client,
  body: BitArray,
  headers: List(Header),
  query: Option(String),
...
pub fn describe_db_shard_groups(
  client: Client,
  body: BitArray,
  headers: List(Header),
  query: Option(String),
...
pub fn describe_tenant_databases(
  client: Client,
  body: BitArray,
  headers: List(Header),
  query: Option(String),
...
pub fn modify_db_recommendation(
  client: Client,
  body: BitArray,
  headers: List(Header),
  query: Option(String),
...
pub fn switchover_global_cluster(
  client: Client,
  body: BitArray,
  headers: List(Header),
  query: Option(String),
