...
pub fn get_group_id(client: Client, request_body: BitArray) -> Request(BitArray) {
  let target = metadata.service_id <> ".GetGroupId"
...
pub fn get_group_membership_id(
  ...
  let target = metadata.service_id <> ".GetGroupMembershipId"
  let headers = [#("X-Amz-Target", target), #("content-type", content_type)]
  request_builder.build(
    client.signer,
    client.endpoint,
...
pub fn get_user_id(client: Client, request_body: BitArray) -> Request(BitArray) {
  let target = metadata.service_id <> ".GetUserId"
  let headers = [#("X-Amz-Target", target), #("content-type", content_type)]
  request_builder.build(
    client.signer,
    client.endpoint,
...
pub fn is_member_in_groups(
  ...
  let target = metadata.service_id <> ".IsMemberInGroups"
  let headers = [#("X-Amz-Target", target), #("content-type", content_type)]
  request_builder.build(
    client.signer,
    client.endpoint,
...
pub fn list_group_memberships_for_member(
  ...
  let target = metadata.service_id <> ".ListGroupMembershipsForMember"
  let headers = [#("X-Amz-Target", target), #("content-type", content_type)]
  request_builder.build(
    client.signer,
    client.endpoint,
