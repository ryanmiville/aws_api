...
pub fn copy_backup_to_region(
  ...
  let target = metadata.service_id <> ".CopyBackupToRegion"
...
pub fn initialize_cluster(
  ...
  let target = metadata.service_id <> ".InitializeCluster"
  let headers = [#("X-Amz-Target", target), #("content-type", content_type)]
  request_builder.build(
    client.signer,
    client.endpoint,
...
pub fn modify_backup_attributes(
  ...
  let target = metadata.service_id <> ".ModifyBackupAttributes"
  let headers = [#("X-Amz-Target", target), #("content-type", content_type)]
  request_builder.build(
    client.signer,
    client.endpoint,
...
pub fn restore_backup(
  ...
  let target = metadata.service_id <> ".RestoreBackup"
  let headers = [#("X-Amz-Target", target), #("content-type", content_type)]
  request_builder.build(
    client.signer,
    client.endpoint,
