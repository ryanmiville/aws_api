...
const metadata = Metadata(
  ...
  service_id: "AWSMPCommerceService_v20200301",
...
pub fn describe_agreement(
  ...
  let target = metadata.service_id <> ".DescribeAgreement"
...
pub fn get_agreement_terms(
  ...
  let target = metadata.service_id <> ".GetAgreementTerms"
  let headers = [#("X-Amz-Target", target), #("content-type", content_type)]
  request_builder.build(
    client.signer,
    client.endpoint,
...
pub fn search_agreements(
  ...
  let target = metadata.service_id <> ".SearchAgreements"
  let headers = [#("X-Amz-Target", target), #("content-type", content_type)]
  request_builder.build(
    client.signer,
    client.endpoint,
