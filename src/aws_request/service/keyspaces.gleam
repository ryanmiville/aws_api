...
pub fn create_keyspace(
  ...
  let target = metadata.service_id <> ".CreateKeyspace"
...
pub fn delete_keyspace(
  ...
  let target = metadata.service_id <> ".DeleteKeyspace"
  let headers = [#("X-Amz-Target", target), #("content-type", content_type)]
  request_builder.build(
    client.signer,
    client.endpoint,
...
pub fn get_keyspace(client: Client, request_body: BitArray) -> Request(BitArray) {
  let target = metadata.service_id <> ".GetKeyspace"
  let headers = [#("X-Amz-Target", target), #("content-type", content_type)]
  request_builder.build(
    client.signer,
    client.endpoint,
...
pub fn get_table_auto_scaling_settings(
  ...
  let target = metadata.service_id <> ".GetTableAutoScalingSettings"
  let headers = [#("X-Amz-Target", target), #("content-type", content_type)]
  request_builder.build(
    client.signer,
    client.endpoint,
...
pub fn list_keyspaces(
  ...
  let target = metadata.service_id <> ".ListKeyspaces"
  let headers = [#("X-Amz-Target", target), #("content-type", content_type)]
  request_builder.build(
    client.signer,
    client.endpoint,
...
pub fn restore_table(
  ...
  let target = metadata.service_id <> ".RestoreTable"
  let headers = [#("X-Amz-Target", target), #("content-type", content_type)]
  request_builder.build(
    client.signer,
    client.endpoint,
