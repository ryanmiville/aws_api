...
pub fn create_host(client: Client, request_body: BitArray) -> Request(BitArray) {
  let target = metadata.service_id <> ".CreateHost"
  let headers = [#("X-Amz-Target", target), #("content-type", content_type)]
  request_builder.build(
    client.signer,
    client.endpoint,
...
pub fn create_repository_link(
  ...
  let target = metadata.service_id <> ".CreateRepositoryLink"
  let headers = [#("X-Amz-Target", target), #("content-type", content_type)]
  request_builder.build(
    client.signer,
    client.endpoint,
...
pub fn create_sync_configuration(
  ...
  let target = metadata.service_id <> ".CreateSyncConfiguration"
  let headers = [#("X-Amz-Target", target), #("content-type", content_type)]
  request_builder.build(
    client.signer,
    client.endpoint,
...
pub fn delete_host(client: Client, request_body: BitArray) -> Request(BitArray) {
  let target = metadata.service_id <> ".DeleteHost"
  let headers = [#("X-Amz-Target", target), #("content-type", content_type)]
  request_builder.build(
    client.signer,
    client.endpoint,
...
pub fn delete_repository_link(
  ...
  let target = metadata.service_id <> ".DeleteRepositoryLink"
  let headers = [#("X-Amz-Target", target), #("content-type", content_type)]
  request_builder.build(
    client.signer,
    client.endpoint,
...
pub fn delete_sync_configuration(
  ...
  let target = metadata.service_id <> ".DeleteSyncConfiguration"
  let headers = [#("X-Amz-Target", target), #("content-type", content_type)]
  request_builder.build(
    client.signer,
    client.endpoint,
...
pub fn get_host(client: Client, request_body: BitArray) -> Request(BitArray) {
  let target = metadata.service_id <> ".GetHost"
  let headers = [#("X-Amz-Target", target), #("content-type", content_type)]
  request_builder.build(
    client.signer,
    client.endpoint,
...
pub fn get_repository_link(
  ...
  let target = metadata.service_id <> ".GetRepositoryLink"
  let headers = [#("X-Amz-Target", target), #("content-type", content_type)]
  request_builder.build(
    client.signer,
    client.endpoint,
...
pub fn get_repository_sync_status(
  ...
  let target = metadata.service_id <> ".GetRepositorySyncStatus"
  let headers = [#("X-Amz-Target", target), #("content-type", content_type)]
  request_builder.build(
    client.signer,
    client.endpoint,
...
pub fn get_resource_sync_status(
  ...
  let target = metadata.service_id <> ".GetResourceSyncStatus"
  let headers = [#("X-Amz-Target", target), #("content-type", content_type)]
  request_builder.build(
    client.signer,
    client.endpoint,
...
pub fn get_sync_blocker_summary(
  ...
  let target = metadata.service_id <> ".GetSyncBlockerSummary"
  let headers = [#("X-Amz-Target", target), #("content-type", content_type)]
  request_builder.build(
    client.signer,
    client.endpoint,
...
pub fn get_sync_configuration(
  ...
  let target = metadata.service_id <> ".GetSyncConfiguration"
  let headers = [#("X-Amz-Target", target), #("content-type", content_type)]
  request_builder.build(
    client.signer,
    client.endpoint,
...
pub fn list_hosts(client: Client, request_body: BitArray) -> Request(BitArray) {
  let target = metadata.service_id <> ".ListHosts"
  let headers = [#("X-Amz-Target", target), #("content-type", content_type)]
  request_builder.build(
    client.signer,
    client.endpoint,
...
pub fn list_repository_links(
  ...
  let target = metadata.service_id <> ".ListRepositoryLinks"
  let headers = [#("X-Amz-Target", target), #("content-type", content_type)]
  request_builder.build(
    client.signer,
    client.endpoint,
...
pub fn list_repository_sync_definitions(
  ...
  let target = metadata.service_id <> ".ListRepositorySyncDefinitions"
  let headers = [#("X-Amz-Target", target), #("content-type", content_type)]
  request_builder.build(
    client.signer,
    client.endpoint,
...
pub fn list_sync_configurations(
  ...
  let target = metadata.service_id <> ".ListSyncConfigurations"
  let headers = [#("X-Amz-Target", target), #("content-type", content_type)]
  request_builder.build(
    client.signer,
    client.endpoint,
...
pub fn update_host(client: Client, request_body: BitArray) -> Request(BitArray) {
  let target = metadata.service_id <> ".UpdateHost"
  let headers = [#("X-Amz-Target", target), #("content-type", content_type)]
  request_builder.build(
    client.signer,
    client.endpoint,
...
pub fn update_repository_link(
  ...
  let target = metadata.service_id <> ".UpdateRepositoryLink"
  let headers = [#("X-Amz-Target", target), #("content-type", content_type)]
  request_builder.build(
    client.signer,
    client.endpoint,
...
pub fn update_sync_blocker(
  ...
  let target = metadata.service_id <> ".UpdateSyncBlocker"
  let headers = [#("X-Amz-Target", target), #("content-type", content_type)]
  request_builder.build(
    client.signer,
    client.endpoint,
...
pub fn update_sync_configuration(
  ...
  let target = metadata.service_id <> ".UpdateSyncConfiguration"
  let headers = [#("X-Amz-Target", target), #("content-type", content_type)]
  request_builder.build(
    client.signer,
    client.endpoint,
