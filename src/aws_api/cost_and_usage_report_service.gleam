...
const metadata = Metadata(
  endpoint_prefix: "cur",
  service_id: "AWSOrigamiServiceGatewayService",
  signing_name: "cur",
  global: option.None,
)
...
pub fn delete_report_definition(
  ...
  let target = metadata.service_id <> ".DeleteReportDefinition"
...
pub fn describe_report_definitions(
  ...
  let target = metadata.service_id <> ".DescribeReportDefinitions"
  let headers = [#("X-Amz-Target", target), #("content-type", content_type)]
  request_builder.build(
    client.signer,
    client.endpoint,
...
pub fn modify_report_definition(
  ...
  let target = metadata.service_id <> ".ModifyReportDefinition"
  let headers = [#("X-Amz-Target", target), #("content-type", content_type)]
  request_builder.build(
    client.signer,
    client.endpoint,
...
pub fn put_report_definition(
  ...
  let target = metadata.service_id <> ".PutReportDefinition"
  let headers = [#("X-Amz-Target", target), #("content-type", content_type)]
  request_builder.build(
    client.signer,
    client.endpoint,
