...
pub fn describe_image_tags(
  ...
  let target = metadata.service_id <> ".DescribeImageTags"
  let headers = [#("X-Amz-Target", target), #("content-type", content_type)]
  request_builder.build(
    client.signer,
    client.endpoint,
...
pub fn describe_registries(
  ...
  let target = metadata.service_id <> ".DescribeRegistries"
  let headers = [#("X-Amz-Target", target), #("content-type", content_type)]
  request_builder.build(
    client.signer,
    client.endpoint,
...
pub fn get_registry_catalog_data(
  ...
  let target = metadata.service_id <> ".GetRegistryCatalogData"
  let headers = [#("X-Amz-Target", target), #("content-type", content_type)]
  request_builder.build(
    client.signer,
    client.endpoint,
...
pub fn get_repository_catalog_data(
  ...
  let target = metadata.service_id <> ".GetRepositoryCatalogData"
  let headers = [#("X-Amz-Target", target), #("content-type", content_type)]
  request_builder.build(
    client.signer,
    client.endpoint,
...
pub fn put_registry_catalog_data(
  ...
  let target = metadata.service_id <> ".PutRegistryCatalogData"
  let headers = [#("X-Amz-Target", target), #("content-type", content_type)]
  request_builder.build(
    client.signer,
    client.endpoint,
...
pub fn put_repository_catalog_data(
  ...
  let target = metadata.service_id <> ".PutRepositoryCatalogData"
  let headers = [#("X-Amz-Target", target), #("content-type", content_type)]
  request_builder.build(
    client.signer,
    client.endpoint,
