...
pub fn create_container(
  ...
  let target = metadata.service_id <> ".CreateContainer"
...
pub fn delete_container(
  ...
  let target = metadata.service_id <> ".DeleteContainer"
  let headers = [#("X-Amz-Target", target), #("content-type", content_type)]
  request_builder.build(
    client.signer,
    client.endpoint,
...
pub fn delete_container_policy(
  ...
  let target = metadata.service_id <> ".DeleteContainerPolicy"
  let headers = [#("X-Amz-Target", target), #("content-type", content_type)]
  request_builder.build(
    client.signer,
    client.endpoint,
...
pub fn delete_cors_policy(
  ...
  let target = metadata.service_id <> ".DeleteCorsPolicy"
  let headers = [#("X-Amz-Target", target), #("content-type", content_type)]
  request_builder.build(
    client.signer,
    client.endpoint,
...
pub fn delete_metric_policy(
  ...
  let target = metadata.service_id <> ".DeleteMetricPolicy"
  let headers = [#("X-Amz-Target", target), #("content-type", content_type)]
  request_builder.build(
    client.signer,
    client.endpoint,
...
pub fn describe_container(
  ...
  let target = metadata.service_id <> ".DescribeContainer"
  let headers = [#("X-Amz-Target", target), #("content-type", content_type)]
  request_builder.build(
    client.signer,
    client.endpoint,
...
pub fn get_container_policy(
  ...
  let target = metadata.service_id <> ".GetContainerPolicy"
  let headers = [#("X-Amz-Target", target), #("content-type", content_type)]
  request_builder.build(
    client.signer,
    client.endpoint,
...
pub fn get_cors_policy(
  ...
  let target = metadata.service_id <> ".GetCorsPolicy"
  let headers = [#("X-Amz-Target", target), #("content-type", content_type)]
  request_builder.build(
    client.signer,
    client.endpoint,
...
pub fn get_metric_policy(
  ...
  let target = metadata.service_id <> ".GetMetricPolicy"
  let headers = [#("X-Amz-Target", target), #("content-type", content_type)]
  request_builder.build(
    client.signer,
    client.endpoint,
...
pub fn list_containers(
  ...
  let target = metadata.service_id <> ".ListContainers"
  let headers = [#("X-Amz-Target", target), #("content-type", content_type)]
  request_builder.build(
    client.signer,
    client.endpoint,
...
pub fn put_container_policy(
  ...
  let target = metadata.service_id <> ".PutContainerPolicy"
  let headers = [#("X-Amz-Target", target), #("content-type", content_type)]
  request_builder.build(
    client.signer,
    client.endpoint,
...
pub fn put_cors_policy(
  ...
  let target = metadata.service_id <> ".PutCorsPolicy"
  let headers = [#("X-Amz-Target", target), #("content-type", content_type)]
  request_builder.build(
    client.signer,
    client.endpoint,
...
pub fn put_metric_policy(
  ...
  let target = metadata.service_id <> ".PutMetricPolicy"
  let headers = [#("X-Amz-Target", target), #("content-type", content_type)]
  request_builder.build(
    client.signer,
    client.endpoint,
...
pub fn start_access_logging(
  ...
  let target = metadata.service_id <> ".StartAccessLogging"
  let headers = [#("X-Amz-Target", target), #("content-type", content_type)]
  request_builder.build(
    client.signer,
    client.endpoint,
...
pub fn stop_access_logging(
  ...
  let target = metadata.service_id <> ".StopAccessLogging"
  let headers = [#("X-Amz-Target", target), #("content-type", content_type)]
  request_builder.build(
    client.signer,
    client.endpoint,
