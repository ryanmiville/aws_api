...
pub fn cancel_resource_request(
  ...
  let target = metadata.service_id <> ".CancelResourceRequest"
...
pub fn get_resource(client: Client, request_body: BitArray) -> Request(BitArray) {
  let target = metadata.service_id <> ".GetResource"
  let headers = [#("X-Amz-Target", target), #("content-type", content_type)]
  request_builder.build(
    client.signer,
    client.endpoint,
...
pub fn get_resource_request_status(
  ...
  let target = metadata.service_id <> ".GetResourceRequestStatus"
  let headers = [#("X-Amz-Target", target), #("content-type", content_type)]
  request_builder.build(
    client.signer,
    client.endpoint,
...
pub fn list_resource_requests(
  ...
  let target = metadata.service_id <> ".ListResourceRequests"
  let headers = [#("X-Amz-Target", target), #("content-type", content_type)]
  request_builder.build(
    client.signer,
    client.endpoint,
